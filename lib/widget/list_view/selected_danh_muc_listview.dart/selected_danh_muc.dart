              ...
              children: [
                      ...
                      IntrinsicHeight(
                        child: Row(
                          children: [
                            ...
                            Text(data.exchange?.toUpperCase()??'',
                            style: const TextStyle(
                              fontSize: 14, fontWeight:FontWeight.bold
                            ),
                            ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(data.closePrice!.toStringAsFixed(2),
                      style: const TextStyle(
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text(data.change!<0?data.change.toString():'+${data.change.toString()}',
                      style:  TextStyle(
                        color: data.change!<0?Colors.red:const Color.fromRGBO(35, 134, 25, 1),
                            fontSize: 16, fontWeight: FontWeight.w500),
                      ),
                      Text(

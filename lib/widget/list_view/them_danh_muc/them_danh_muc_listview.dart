                        ...
                        builder: (context, isSelected, child) {
                          return IconButton(
                              onPressed: () {
                                ...
                                _appProvider.getChungKhoan[index].isSave = _appProvider.changeIsSave(data.isSave ?? 0);
                                   
                                print(' chung khoan is Save click ${data.isSave}');
                                    
                                print(' chung khoan  click ${_appProvider.checkSelected}');
                                    
                                if (_appProvider.getChungKhoan[index].isSave ==1){
